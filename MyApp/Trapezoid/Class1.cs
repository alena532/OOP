...
namespace Trapezoid
{
    ...
    {
        public Trapezoid(int figureType, Point point1, Point point2, Color lineColor, Color fillColor, double width) : base(figureType, point1, point2, lineColor, fillColor, width)
        {
    ...
    public class ArcCreator : FigureCreator
    {
        ...
        {
            return new Trapezoid(figureType, point1, point2, lineColor, fillColor, width);
        }
    }
}